                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div id="details-slider" class="details-slider carousel slide" data-ride="carousel">
                                            <ol class="carousel-indicators">
                                                <li data-target="#details-slider" data-slide-to="0" class="active"><img src="images/product/dried-peaches/huesillo.jpg" alt="Image" class="img-fluid"></li>
                                                <li data-target="#details-slider" data-slide-to="1"><img src="images/product/dried-peaches/5B8.jpg" alt="Image" class="img-fluid"></li>
                                            </ol>
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item item active">
                                                    <img class="img-fluid" src="images/product/dried-peaches/huesillo.jpg" alt="Image">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="img-fluid" src="images/product/dried-peaches/5B8.jpg" alt="Image">
                                                </div>
                                            </div>
                                        </div><!-- /#details-slider -->  
                                    </div>
                                    <div class="col-lg-6 d-flex justify-content-center">
                                        <div class="product-details-info">
                                            <span class="product-title"> <strong>Huesillo</strong></span>
                                            <span class="price"><del>$15.00</del>$12.00</span>
                                            
                                            <p>Huesillo Orgánico</p>
