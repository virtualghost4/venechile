    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <a class="navbar-brand" href="?action=inicio">Venechile</a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="?action=productos"><i class="fa fa-fw fa-dashboard"></i> Productos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?action=informacion"><i class="fa fa-fw fa-area-chart"></i> Información</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?action=fotografias"><i class="fa fa-fw fa-table"></i> Fotografías</a>
                </li>
            </ul>
